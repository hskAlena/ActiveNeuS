...
from typing import Any, Optional, Type, List, Literal, Tuple
...
@dataclass
class ExponentialDecaySchedulerConfig(InstantiateConfig):
    """Basic scheduler config with self-defined exponential decay schedule"""
...
class ExponentialDecayScheduler(lr_scheduler.LambdaLR):
    ...
    def __init__(self, optimizer: Optimizer, lr_init: float, lr_final, max_steps, ramp='linear', lr_pre_warmup=1e-8, warmup_steps=0) -> LRScheduler:
