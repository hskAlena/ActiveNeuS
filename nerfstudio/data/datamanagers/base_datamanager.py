...
from nerfstudio.data.dataparsers.blendedmvs_dataparser import BlendedMVSDataParserConfig
...
from nerfstudio.data.dataparsers.llff_dataparser import LLFFDataParserConfig
    ...
    tyro.extras.subcommand_type_from_defaults(
        {
            ...
            "blendedmvs-data": BlendedMVSDataParserConfig(),
            "heritage-data": HeritageDataParserConfig(),
            "llff-data": LLFFDataParserConfig(),
        },
