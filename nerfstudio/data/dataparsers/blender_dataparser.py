...
class Blender(DataParser):
    ...
    def __init__(self, config: BlenderDataParserConfig):
        ...
        self.skip_every_for_val_split = config.skip_every_for_val_split
    ...
    def _generate_dataparser_outputs(self, split="train"):
        ...
        if split == 'val':
            split = 'test'
            self.skip_every_for_val_split = 8
        ...
        if split    != "train" and self.skip_every_for_val_split >= 1:
            image_filenames = image_filenames[::self.skip_every_for_val_split]
            poses = poses[::self.skip_every_for_val_split]
        if split=='val':
        ...
        cameras = Cameras(
            ...
            precrop_iters=self.precrop_iters,
