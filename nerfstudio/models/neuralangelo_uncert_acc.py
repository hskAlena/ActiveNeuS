...
from nerfstudio.models.active_neus_acc import ActiveNeuSAccModel, ActiveNeuSAccModelConfig
from nerfstudio.utils import colormaps


@dataclass
class NeuralangeloUncertAccModelConfig(ActiveNeuSAccModelConfig):
    """Neuralangelo Model Config"""

    _target: Type = field(default_factory=lambda: NeuralangeloUncertAccModel)
...
class NeuralangeloUncertAccModel(ActiveNeuSAccModel):
    """Neuralangelo model
    ...
    config: NeuralangeloUncertAccModelConfig
