...
ns-train active_neus-acc --pipeline.model.sdf-field.inside-outside False \
 ...
 --pipeline.model.overwrite_near_far_plane True \
    ...
    --experiment-name "neus-acc-entropy-topk-60k1k-Freq30k-total10Mask-${dataset}" \
    sdfstudio-data --data "data/dtu/${dataset}" --include_foreground_mask True \
    --indices_file "outputs/neus-acc-entropy-topk-60k1k-Freq30k-total10Mask-${dataset}/indices.txt"
done
wait
echo "Done."
...
ns-train active_neus-acc --pipeline.model.sdf-field.inside-outside False \
 ...
 --pipeline.model.overwrite_near_far_plane True \
      ...
      --pipeline.model.sdf-field.freq_reg_end 30000 \
      --pipeline.model.sdf-field.frequency_regularizer True \
    --experiment-name "neus-acc-random-60k1k-Freq30k-total10Mask-${dataset}" \
    sdfstudio-data --data "data/dtu/${dataset}" --include_foreground_mask True \
    --indices_file "outputs/neus-acc-random-60k1k-Freq30k-total10Mask-${dataset}/indices.txt"
done
wait
echo "Done."
###################################################################################
...
ns-train active_neus-acc --pipeline.model.sdf-field.inside-outside False \
 ...
 --pipeline.model.overwrite_near_far_plane True \
    ...
    #   --pipeline.model.sdf-field.freq_reg_end 30000 \
    #   --pipeline.model.sdf-field.frequency_regularizer True \
    --experiment-name "neus-acc-entropy-topk-120k2k-Freq30k-total20Mask-${dataset}" \
    sdfstudio-data --data "data/dtu/${dataset}" --include_foreground_mask True \
    --indices_file "outputs/neus-acc-entropy-topk-120k2k-Freq30k-total20Mask-${dataset}/indices.txt"
done
wait
echo "Done."
...
ns-train active_neus-acc --pipeline.model.sdf-field.inside-outside False \
 ...
 --pipeline.model.overwrite_near_far_plane True \
    ...
    #   --pipeline.model.sdf-field.freq_reg_end 30000 \
    #   --pipeline.model.sdf-field.frequency_regularizer True \
    --experiment-name "neus-acc-random-120k2k-Freq30k-total20Mask-${dataset}" \
    sdfstudio-data --data "data/dtu/${dataset}" --include_foreground_mask True \
    --indices_file "outputs/neus-acc-random-120k2k-Freq30k-total20Mask-${dataset}/indices.txt"
done
wait
echo "Done."