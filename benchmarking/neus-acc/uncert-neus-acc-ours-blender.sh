...
ns-train active_uncert_neus-acc --pipeline.model.sdf-field.inside-outside False \
 ...
 --pipeline.model.kimera_type none --pipeline.model.overwrite_near_far_plane True \
    ...
    --experiment-name "uncert_neus-acc-frontier-dist-100k1k-precrop6-Freq40k-total10-${dataset}" \
...
ns-train active_uncert_neus-acc --pipeline.model.sdf-field.inside-outside False \
 ...
 --pipeline.model.kimera_type none --pipeline.model.overwrite_near_far_plane True \
      ...
      --pipeline.model.sdf-field.frequency_regularizer True \
      --pipeline.datamanager.precrop-iters 750 --pipeline.datamanager.precrop-frac 0.6 \
    --experiment-name "uncert_neus-acc-frontier-topk-100k1k-precrop6-Freq40k-total10-${dataset}" \
    blender-data --data "data/blender/${dataset}" --skip_every_for_val_split 8 \
    --precrop-iters 750 --precrop-frac 0.6
done
wait
...
ns-train active_uncert_neus-acc --pipeline.model.sdf-field.inside-outside False \
 ...
 --pipeline.model.kimera_type none --pipeline.model.overwrite_near_far_plane True \
      ...
      --pipeline.model.sdf-field.frequency_regularizer True \
      --pipeline.datamanager.precrop-iters 750 --pipeline.datamanager.precrop-frac 0.6 \
    --experiment-name "uncert_neus-acc-frontier-topk-no_surface-100k1k-precrop6-Freq40k-total10-${dataset}" \
    blender-data --data "data/blender/${dataset}" --skip_every_for_val_split 8 \
    --precrop-iters 750 --precrop-frac 0.6
done
wait
...
ns-train active_uncert_neus-acc --pipeline.model.sdf-field.inside-outside False \
 ...
 --pipeline.model.kimera_type none --pipeline.model.overwrite_near_far_plane True \
      ...
      --pipeline.model.sdf-field.frequency_regularizer True \
      --pipeline.datamanager.precrop-iters 750 --pipeline.datamanager.precrop-frac 0.6 \
    --experiment-name "uncert_neus-acc-frontier-dist-no_surface-100k1k-precrop6-Freq40k-total10-${dataset}" \
    blender-data --data "data/blender/${dataset}" --skip_every_for_val_split 8 \
    --precrop-iters 750 --precrop-frac 0.6
done
wait
...
ns-train active_uncert_neus-acc --pipeline.model.sdf-field.inside-outside False \
 ...
 --pipeline.model.kimera_type none --pipeline.model.overwrite_near_far_plane True \
    ...
    --experiment-name "uncert_neus-acc-frontier-dist-200k2k-precropW12-total20-${dataset}" \
    blender-data --data "data/blender/${dataset}" --skip_every_for_val_split 8 \
