...
ns-train active_uncert_neus-acc --pipeline.model.sdf-field.inside-outside False \
 ...
 --pipeline.model.kimera_type none --pipeline.model.overwrite_near_far_plane True \
    ...
    --experiment-name "uncert_neus-acc-frontier-dist-60k1k-Freq30k-total10Mask-${dataset}" \
    sdfstudio-data --data "data/dtu/${dataset}" --include_foreground_mask True \
    --indices_file "outputs/uncert_neus-acc-frontier-dist-60k1k-Freq30k-total10Mask-${dataset}/indices.txt"
done
wait
echo "Done."
...
ns-train active_uncert_neus-acc --pipeline.model.sdf-field.inside-outside False \
    ...
    --trainer.steps_per_eval_all_images 60000 --pipeline.datamanager.train_num_rays_per_batch 512 \
    --optimizers.fields.scheduler.max_steps 60001 \
 --pipeline.model.acquisition frontier --pipeline.model.choose_multi_cam topk \
 --pipeline.model.uncert_rgb_loss_mult 0.001 --pipeline.model.uncert_beta_loss_mult 0.01 \
 --pipeline.model.entropy_type ent --pipeline.model.grid_sampling True \
 --pipeline.model.kimera_type none --pipeline.model.overwrite_near_far_plane True \
      --pipeline.model.background_color="black" --pipeline.model.scene_contraction_norm l2 \
      ...
      --pipeline.model.sdf-field.freq_reg_end 30000 \
      --pipeline.model.sdf-field.frequency_regularizer True \
    --experiment-name "uncert_neus-acc-frontier-topk-60k1k-Freq30k-total10Mask-${dataset}" \
    sdfstudio-data --data "data/dtu/${dataset}" --include_foreground_mask True \
    --indices_file "outputs/uncert_neus-acc-frontier-topk-60k1k-Freq30k-total10Mask-${dataset}/indices.txt"
done
wait
echo "Done."
...
ns-train active_uncert_neus-acc --pipeline.model.sdf-field.inside-outside False \
 ...
 --pipeline.model.kimera_type none --pipeline.model.overwrite_near_far_plane True \
      ...
      --pipeline.model.sdf-field.freq_reg_end 30000 \
      --pipeline.model.sdf-field.frequency_regularizer True \
    --experiment-name "uncert_neus-acc-frontier-dist-no_surface-60k1k-Freq30k-total10Mask-${dataset}" \
    sdfstudio-data --data "data/dtu/${dataset}" --include_foreground_mask True \
    --indices_file "outputs/uncert_neus-acc-frontier-dist-no_surface-60k1k-Freq30k-total10Mask-${dataset}/indices.txt"
done
wait
echo "Done."
...
ns-train active_uncert_neus-acc --pipeline.model.sdf-field.inside-outside False \
 ...
 --pipeline.model.kimera_type none --pipeline.model.overwrite_near_far_plane True \
      ...
      --pipeline.model.sdf-field.freq_reg_end 30000 \
      --pipeline.model.sdf-field.frequency_regularizer True \
    --experiment-name "uncert_neus-acc-frontier-topk-no_surface-60k1k-Freq30k-total10Mask-${dataset}" \
    sdfstudio-data --data "data/dtu/${dataset}" --include_foreground_mask True \
    --indices_file "outputs/uncert_neus-acc-frontier-topk-no_surface-60k1k-Freq30k-total10Mask-${dataset}/indices.txt"
done
wait
echo "Done."
...
ns-train active_uncert_neus-acc --pipeline.model.sdf-field.inside-outside False \
 ...
 --pipeline.model.kimera_type none --pipeline.model.overwrite_near_far_plane True \
      ...
      # --pipeline.model.sdf-field.freq_reg_end 30000 \
      # --pipeline.model.sdf-field.frequency_regularizer True \
    --experiment-name "uncert_neus-acc-frontier-dist-120k2k-Freq30k-total20Mask-${dataset}" \
    sdfstudio-data --data "data/dtu/${dataset}" --include_foreground_mask True \
    --indices_file "outputs/uncert_neus-acc-frontier-dist-120k2k-Freq30k-total20Mask-${dataset}/indices.txt"
done
wait
echo "Done."