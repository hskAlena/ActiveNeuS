...
ns-train active_uncert_neus-acc --pipeline.model.sdf-field.inside-outside False \
 ...
 --pipeline.model.overwrite_near_far_plane True \
    ...
    --experiment-name "uncert_neus-acc-active-precrop6-topk-100k1k-total10-Freq40k-${dataset}" \
...
ns-train active_uncert_neus-acc --pipeline.model.sdf-field.inside-outside False \
 ...
 --pipeline.model.overwrite_near_far_plane True \
    ...
    --experiment-name "uncert_neus-acc-active-topk-200k2k-precropW12-total20-${dataset}" \
    blender-data --data "data/blender/${dataset}" --skip_every_for_val_split 8 \
