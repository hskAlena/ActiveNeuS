...
ns-train active-nerf-acc \
 ...
 --pipeline.model.uncert_rgb_loss_mult 0.001 --pipeline.model.uncert_beta_loss_mult 0.01 \
    ...
    --experiment-name "nerf-acc-active-topk-60k1k-Freq30k-total10Mask-${dataset}" \
    sdfstudio-data --data "data/dtu/${dataset}" --include_foreground_mask True \
    --indices_file "outputs/nerf-acc-active-topk-60k1k-Freq30k-total10Mask-${dataset}/indices.txt"
done
wait
echo "Done."
...
ns-train active-nerf-acc \
 ...
 --pipeline.model.uncert_rgb_loss_mult 0.001 --pipeline.model.uncert_beta_loss_mult 0.01 \
    ...
    --experiment-name "nerf-acc-active-topk-120k2k-total20Mask-${dataset}" \
    sdfstudio-data --data "data/dtu/${dataset}" --include_foreground_mask True \
    --indices_file "outputs/nerf-acc-active-topk-120k2k-total20Mask-${dataset}/indices.txt"
done
wait
echo "Done."
